...
export const CHALLENGES: ShifraChallenge[] = [
  { id: "s-mem-1", type: "memory", title: "سلسلة الذاكرة", instruction: "يقرأ الرائد ٥ أرقام مرّة واحدة، ويعيدها الفريق بالترتيب نفسه" },
  { id: "s-mem-2", type: "memory", title: "ماذا اختفى؟", instruction: "يعرض الرائد ٦ رموز ١٠ ثوانٍ، يخفي واحدًا، ويخمّن الفريق المفقود" },
  { id: "s-spd-1", type: "speed", title: "أسرع إجابة", instruction: "يسأل الرائد سؤالًا سريعًا، وأول فريق يرفع يده بالإجابة الصحيحة يكسب" },
  ...
  { id: "s-team-1", type: "team", title: "رسالة صامتة", instruction: "يوصل الفريق كلمة من أوّله لآخره بالإشارة فقط دون كلام" },
  { id: "s-team-2", type: "team", title: "الاتفاق السريع", instruction: "يتّفق الفريق على إجابة واحدة لسؤال الرائد خلال ١٥ ثانية" },
  { id: "s-obs-1", type: "observation", title: "عين دقيقة", instruction: "كم بابًا في هذه القاعة؟ يتّفق الفريق على رقم واحد ثم نتحقّق" },
  { id: "s-obs-2", type: "observation", title: "الفرق الخفي", instruction: "يصف الرائد مشهدين متشابهين، ويكتشف الفريق الفرق الوحيد" },
