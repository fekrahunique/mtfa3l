...
const benefits = [
  {
    icon: RocketLaunch,
    title: "يخطّط لك أسبوعك",
    body: "حصص وأنشطة جاهزة تحقّق المستهدف الأسبوعي، بلا تحضير ولا بداية من الصفر.",
  },
  {
    icon: PuzzlePiece,
    title: "يشغّل التجربة على الشاشة",
    body: "عروض ومسابقات وألعاب تفاعلية يعيشها فصلك، لا مجرد محتوى يُقرأ.",
  },
  {
    icon: Toolbox,
    title: "يدير المنافسة والفصل",
    body: "فرق ونقاط وفائزون، وتوزيع مجموعات وإدارة فصولك بضغطة.",
  },
  {
    icon: ChartLineUp,
    title: "يقيس أثرك ويوثّقه",
    body: "قياس تفاعل كل نشاط، وملف إنجاز PDF جاهز للرفع في نهاية الشهر.",
  },
  {
    icon: FileArrowUp,
    title: "قائمة طلابك بضغطة",
    body: "ارفع ملف الأسماء، وتنقرأ تلقائيًا وتُجهَّز أنشطة طلابك.",
  },
];
    ...
    <div className="mx-auto max-w-6xl px-4 py-24">
      <ScrollReveal className="mx-auto max-w-[680px] text-center">
        ...
        <p className="mt-4 text-lg text-ink-muted">
          من التخطيط إلى التنفيذ إلى القياس والتوثيق، نظام واحد يدير نشاطك ويوفّر ساعاتك
        </p>
      </ScrollReveal>
