...
export function PrivacyPolicy() {
  return (
    <LegalLayout title="سياسة الخصوصية" updated="7 أغسطس 2026">
      <p>
        متفاعل منصة موجهة لرواد ورائدات النشاط في المدارس الحكومية والأهلية. نجمع فقط
      ...
      <p>
        أسماء الطلاب تُستخدم فقط لإنشاء حسابات دخول للتفاعل مع الأنشطة داخل المنصة،
        ولا تُشارك مع أي جهة خارجية. يبقى المعلم أو المعلمة المسؤول المباشر عن دقة
        الأسماء المرفوعة، وله الحق في حذف أي حساب طالب في أي وقت من لوحة التحكم.
      </p>
...
export function Terms() {
  return (
    <LegalLayout title="الشروط والأحكام" updated="7 أغسطس 2026">
      <p>
        باستخدامك منصة متفاعل، فأنت توافق على استخدامها في الغرض المخصص لها: تنفيذ
      ...
      <p>
        ...
        المنفذة لسياسات مدرسته. متفاعل توفر الأدوات والمحتوى، والقرار النهائي
