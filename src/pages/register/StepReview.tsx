  ...
  return (
    <ScrollReveal className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-faint">تأكد من بياناتك قبل البدء</p>
      </div>

      {/* بطاقة الباقة والسعر مستبدَلة بشارة التجربة في وضع TRIAL_MODE */}
      <div className="rounded-2xl border border-sun-400/30 bg-sun-400/[0.07] p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs text-ink-faint">نسخة تجريبية</p>
            <p className="font-display text-lg text-ink">كل الأدوات مفتوحة</p>
          </div>
        </div>
        <p className="mt-3 rounded-xl bg-white/[0.04] px-3 py-2 text-xs leading-relaxed text-ink-muted">
          🚀 المنصة مفتوحة بالكامل خلال فترة التجربة — جرّب كل الأنشطة والأدوات بلا اشتراك
        </p>
      </div>
