...
const ROUTES: { to: string; label: string; note: string }[] = [
  ...
  { to: "/مخطط-النشاط", label: "📅 المخطّط الذكي", note: "خطة أسابيع تلقائية (باقة عليا)" },
  { to: "/سجل-النشاط", label: "📊 سجّل أثرك في النشاط", note: "قياس + توثيق + ملف إنجاز PDF (باقة عليا)" },
  { to: "/الأسبوع-التمهيدي-١٤٤٨", label: "📢 حملة الأسبوع التمهيدي", note: "صفحة حملة مبنية على التعميم" },
  { to: "/بطاقة-الملاحظة", label: "📋 استمارة الملاحظة", note: "ملاحظة يومية للطلاب تُطبع (باقة عليا)" },
  { to: "/بطاقات-التعريف", label: "🪪 بطاقات التعريف", note: "بطاقات ترحيب للطلاب تُطبع (باقة عليا)" },
  { to: "/أركان-التمهيدي", label: "🎪 الأركان الجاهزة", note: "أركان التمهيدي ببطاقات تنفيذ ولافتات" },
  { to: "/تقرير-البرنامج", label: "📄 تقرير تنفيذ برنامج", note: "تقرير رسمي بهوية الوزارة جاهز PDF (باقة عليا)" },
  { to: "/حصص-النشاط", label: "📐 موزّع حصص النشاط", note: "حاسبة نسبة ١٠٪ وتوزيعها على المواد (باقة عليا)" },
];
